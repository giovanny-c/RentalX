...
router.use("/categories", _categories.categoriesRoutes); //usa as rotas de categoriesRoutes no path /categories

router.use("/specifications", _specifications.specificationsRoutes);
router.use("/users", _users.usersRoutes);
router.use(_authenticate.authenticateRoutes); //vai usar direto(/sessions)
