...
let ListAvailableCarsUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const cars = await this.carsRepository.findAvailable(brand, category_id, name); //vai procurar todos os carros disponiveis ou todos disponiveis por nome ou marca ou categoria
