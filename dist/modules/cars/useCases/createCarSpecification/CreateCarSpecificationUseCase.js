...
let CreateCarSpecificationUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const specifications = await this.specificationsRepository.findByIds(specifications_ids); //vai procurar todas as especificaçoes
    //na tabela  specifications
    //que tenham os ids que foram passados

    carExists.specifications = specifications; //pega as specificaçoes encontradas 
