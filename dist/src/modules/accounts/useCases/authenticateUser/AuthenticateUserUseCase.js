...
let AuthenticateUserUseCase = class AuthenticateUserUseCase {
    ...
    execute({ email, password }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { expires_refresh_token_days, expires_in_refresh_token, expires_in_token, secret_refresh_token, secret_token } = auth_1.default;
            if (!user) {
                throw new AppError_1.AppError("Email or password incorret");
            }
            //senha correta?
