    ...
    execute(token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const refresh_token = (0, jsonwebtoken_1.sign)({ email }, auth_1.default.secret_refresh_token, {
                subject: user_id,
                expiresIn: auth_1.default.expires_in_refresh_token //30 dias
            });
            //adicionado 30 dias ao dia atual para expiração
            const refresh_token_expires_date = this.dateProvider.addDays(auth_1.default.expires_refresh_token_days);
            ...
            const newToken = (0, jsonwebtoken_1.sign)({}, auth_1.default.secret_token, {
                subject: user_id,
                expiresIn: auth_1.default.expires_in_token //15 minutos
            });
            return {
                token: newToken,
                refresh_token
