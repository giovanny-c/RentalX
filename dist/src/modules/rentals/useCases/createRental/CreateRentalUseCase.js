    ...
    execute({ user_id, car_id, expected_return_date }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (carUnavailable) { //se achar um aluguel com esse carro que nao foi terminado
                throw new AppError_1.AppError("This car is not available for rent right now");
            }
            ...
            if (rentalOpenToUser) { //se achar um aluguel com esse user emandamento
                throw new AppError_1.AppError("There is already a rental in progress for this user");
            }
            ...
            if (compare < minRentTime) {
                throw new AppError_1.AppError("The rent should be longer than 1 day (24 hours)");
            }
